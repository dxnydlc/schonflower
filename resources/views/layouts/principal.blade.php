...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Schon</b>Flower</span>
    </a>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!-- Contentenido de nuestra página -->
      @yield('content')
    </section>
    <!-- /.content -->
  </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016-2016 <a href="http://almsaeedstudio.com">yupicode.com</a>.</strong> All rights reserved.
  </footer>
